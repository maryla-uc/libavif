...
void MakeImage(const std::string& path, uint32_t grid_cols, uint32_t grid_rows,
               uint32_t cell_width, uint32_t cell_height,
               uint32_t gain_map_grid_cols, uint32_t gain_map_grid_rows,
               uint32_t gain_map_cell_width, uint32_t gain_map_cell_height,
               uint8_t tmap_version = 0, uint16_t minimum_version = 0,
               uint16_t writer_version = 0, bool add_extra_bytes = false) {
  std::vector<ImagePtr> cells;
  std::vector<const avifImage*> cell_ptrs;
  ...
  avifGainMapMetadata gain_map_metadata =
      GetTestGainMapMetadata(/*base_rendition_is_hdr=*/true);
  gain_map_metadata.tmapVersion = tmap_version;
  gain_map_metadata.minimumVersion = minimum_version;
  gain_map_metadata.writerVersion = writer_version;
  gain_map_metadata.addExtraBytes = add_extra_bytes;
  ...
  encoder->speed = 10;
  testutil::AvifRwData encoded;
  avifResult result = avifEncoderAddImageGrid2(
...
TEST(GainMapTest, CreateGainMapImages) {
  MakeImage(std::string(data_path) + "color_grid_gainmap_different_grid.avif",
            /*grid_cols=*/4,
            /*grid_rows=*/3,
  ...
  MakeImage(
      ...
      /*gain_map_grid_cols=*/2, /*gain_map_grid_rows=*/2,
      /*gain_map_cell_width=*/64, /*gain_map_cell_height=*/80);
  MakeImage(std::string(data_path) + "unsupported_gainmap_version.avif",
            /*grid_cols=*/1,
            /*grid_rows=*/1,
            /*cell_width=*/100, /*cell_heigh=*/100,
            /*gain_map_grid_cols=*/1, /*gain_map_grid_rows=*/1,
            /*gain_map_cell_width=*/50, /*gain_map_cell_height=*/50,
            /*tmap_version=*/99, /*minimum_version=*/0, /*writer_version=*/0);
  MakeImage(std::string(data_path) + "unsupported_gainmap_minimum_version.avif",
            /*grid_cols=*/1,
            /*grid_rows=*/1,
            /*cell_width=*/100, /*cell_heigh=*/100,
            /*gain_map_grid_cols=*/1, /*gain_map_grid_rows=*/1,
  ...
  MakeImage(std::string(data_path) +
  ...
  MakeImage(std::string(data_path) +
            ...
            /*gain_map_grid_cols=*/1, /*gain_map_grid_rows=*/1,
            /*gain_map_cell_width=*/50, /*gain_map_cell_height=*/50,
            /*tmap_version=*/0, /*minimum_version=*/0, /*writer_version=*/0,
            /*add_extra_bytes=*/1);
}
